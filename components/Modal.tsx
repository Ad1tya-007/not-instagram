...
import { db, storage } from '../firebase-setup/firebase.js'
import {
  addDoc,
  collection,
  serverTimestamp,
...
export default function Modal() {
  ...
  return (
    <Transition.Root show={open} as={Fragment}>
      ...
      >
        <div
          className="flex min-h-[800px] items-end 
        justify-center pt-4 pb-20
              ...
              <div className="">
                {selectedFile ? (
                  ...
                  <div
                    ...
                    className="mx-auto flex h-12 w-12 cursor-pointer items-center
                  ...
                  <div className="mt-3 text-center sm:mt-5">
                    ...
                    <div className="mt-2">
                      <input
                        type="text"
                        className="w-full
                    border-none text-center focus:ring-0"
                        ref={captionRef}
